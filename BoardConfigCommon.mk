...
BOARD_SUPER_PARTITION_BLOCK_DEVICES := super oem_a oem_b
BOARD_SUPER_PARTITION_OEM_A_DEVICE_SIZE := 608174080 # 580 MB (F JP Ver, CN is 800 MB)
BOARD_SUPER_PARTITION_OEM_B_DEVICE_SIZE := 608174080 # 580 MB (F JP Ver, CN is 800 MB)
BOARD_SUPER_PARTITION_SUPER_DEVICE_SIZE := 11811160064  # 11.0 GB (F JP Ver, CN is 11.5 GB)
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_OEM_A_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_OEM_B_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_SUPER_DEVICE_SIZE))
# Dynamic partition size = (Super partition size / 2) - 4MB
BOARD_SOMC_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) / 2 - 4194304 )
